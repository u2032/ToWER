 ...
 * @author Cédric Longo
 */
public final class CloseTournamentDialog extends Alert {
    ...
    public CloseTournamentDialog( final CloseTournamentDialogModel model ) {
        ...
        contentTextProperty( ).bind( model.getI18n( ).get( "tournament.close.tournament.message" ) );
